...
import SearchProvider from '../SearchBbg/search';
import WithSearch from '../SearchBbg/search';
  ...
  render () {
    const blogRecords = this.state.blogItems.map (blogItem => {
      if (this.props.loggedInStatus === 'LOGGED_IN') {
        return (
          <div key={blogItem.id} className="admin-blog-wrapper" id="delete">
            <BlogItem blogItem={blogItem} />
            <a
              id="deletelink"
              className="admin-blog"
    ...
    return (
      <div className="blog-container">
        <Header />
        {<SearchProvider className="search-bar" />}

        <h2 className="blogsecondarytitles">Blog</h2>
        <BlogModal
        ...
        {this.props.loggedInStatus === 'LOGGED_IN'
          ? <div className="new-blog-link">
              <a className="blog-link" onClick={this.handleNewBlogClick}>
